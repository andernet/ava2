  ...
  <div class="row">
    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 mt-5 pt-3 pb-3 bg-white from-wrapper">
      <div class="container">
        ...
        <form class="" action="<?= base_url('alunoauth/check') ?>" method="post">
          <?= csrf_field(); ?>
         ...
         <?php endif?>
          <div class="form-group">
           ...
           <input type="text" placeholder="Ex: aluno007"  class="form-control" name="username" id="username" value="<?= set_value('username') ?>">
          </div>
          <div class="form-group">
